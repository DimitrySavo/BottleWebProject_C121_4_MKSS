...
class TestDiameter(unittest.TestCase):
    def test_diameter(self):
        ...
        self.assertEqual(graph2.diameter(), float('inf'))  # Нет связей, значит нет конечного диаметра
        ...
        self.assertEqual(graph6.diameter(), float('inf'))  # Нет конечного пути между всеми узлами
